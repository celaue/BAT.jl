...
vjp_algorithm(f::DensityInterface.LogDensityOf) = vjp_algorithm(f.density)
vjp_algorithm(f::Negative) = vjp_algorithm(f.density)
...
jvp_algorithm(f::DensityInterface.LogDensityOf) = jvp_algorithm(f.density)
